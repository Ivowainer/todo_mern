...
const Card = ({ name, description, author, priority }) => {
  ...
  return (
    <div className='flex flex-col w-1/4 h-48 my-10 text-gray-700 px-3 pt-3 relative'>
        <div className='absolute top-0 left-0 text-[10px] p-[8px] text-center bg-red-500 rounded-full text-white cursor-pointer'><BsFillTrashFill /></div> 
        <div className='absolute top-0 right-0 text-[10px] p-[8px] text-center bg-blue-500 rounded-full text-white cursor-pointer'><BsFillPencilFill /></div> 
