...
const Card = ({ id, name, description, author, priority }) => {
  const { deleteTask } = useTaskProvider()
  ...
  return (
    <div className='flex flex-col w-1/4 h-48 my-10 text-gray-700 px-3 pt-3 relative'>
        ...
        <button className='absolute top-0 right-0 text-[10px] p-[8px] text-center bg-blue-500 rounded-full text-white cursor-pointer'><BsFillPencilFill /></button> 
