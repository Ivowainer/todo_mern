    ...
    <>
      ...
      <div className='flex-col h-full w-full flex'>
        <div className="bg-white shadow-2xl h-1/5 rounded-lg flex items-center px-10 mb-5">
          <button className="flex transition-color duration-500 items-center gap-1 outline-none justify-center text-md px-5 py-2 bg-default hover:bg-white rounded-lg text-white hover:text-default hover:border-default hover:border" onClick={() => setIsOpen(true)}><AiOutlinePlusCircle/>Add Task</button>
        </div>
